...
public abstract class PipelineDSLGlobal extends GlobalVariable {
    ...
    @Extension
    public static class RapidDeployConnectorAllowlist extends GroovySourceFileAllowlist {
        private final String scriptUrl = PipelineDSLGlobal.class.getResource("/dsl/RdConnectorProxy.groovy").toString();

        @Override
        public boolean isAllowed(final String groovyResourceUrl) {
